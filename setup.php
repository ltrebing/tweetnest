...
<?php if (!isset($_SESSION['access_token'])) { ?>
					<a href="inc/twitteroauth/redirect.php" id="twitter_auth"><img src="inc/twitteroauth/images/lighter.png" alt="Sign in with Twitter" /></a>
<?php } else { ?>
					Authorized
<?php } ?>
				</div>
